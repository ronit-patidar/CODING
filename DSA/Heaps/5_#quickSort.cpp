...
// 2. Rearrange the array so that elements smaller than the pivot are on the left 
//    and larger elements are on the right (partitioning step). IMP STEP
// 3. Recursively apply QuickSort to the left and right subarrays.
// 4. Base Case: If the subarray has one or no elements, return.
